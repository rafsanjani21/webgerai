...
const NotificationModal = ({
  ...
  isOpen: boolean; title: string; message: string; type: "success" | "error"; onClose: () => void;
}) => {
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl w-full max-w-[340px] flex flex-col shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-6 text-center flex flex-col items-center">
          ...
          <button onClick={onClose} className="w-full bg-blue-700 hover:bg-blue-800 text-white py-3.5 rounded-xl font-bold tracking-wide transition-colors text-sm">
            TUTUP
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl w-full max-w-[340px] flex flex-col shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-6 flex flex-col">
          ...
          <div className="mb-4">
            ...
            {errorMsg ? (
              <p className="text-xs text-rose-500 font-bold mt-1.5">{errorMsg}</p>
            ) : (
              <p className="text-[10px] text-slate-400 font-medium mt-1.5">Saldo aktif: <span className="font-bold text-slate-600">{formatRupiah(saldoTersedia)}</span></p>
            )}
          </div>
...
export default function Home() {
    ...
    try {
      ...
      if (response.ok) {
        setNotification({
          ...
          message: resData.message || `Penarikan dana sebesar ${formatRupiah(amount)} berhasil diproses.`,
          type: "success"
        });
        setWithdrawalPage(1);
  ...
  const slicedReferredUsers = user.referredUsers.slice((referredPage - 1) * ITEMS_PER_PAGE, referredPage * ITEMS_PER_PAGE);
  const slicedWithdrawalHistory = user.withdrawalHistory.slice((withdrawalPage - 1) * ITEMS_PER_PAGE, withdrawalPage * ITEMS_PER_PAGE);
      ...
      <div className="w-full max-w-[420px] bg-white min-h-screen relative shadow-2xl overflow-x-hidden pb-24">
        ...
        <div className="bg-[#4461AD] pt-10 pb-[100px] px-6 rounded-b-xl relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-14 h-14 bg-yellow-100 rounded-full overflow-hidden flex items-center justify-center border-2 border-white/20">
                {user.photoSelfieUrl ? (
                  ...
                  <svg className="w-12 h-12 text-[#4461AD] mt-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-4 gap-2 mt-6 px-1">
            ...
            <div className="flex flex-col items-center gap-1.5 cursor-pointer" onClick={() => setActiveTab("referral")}>
              <div className="w-12 h-12 border-2 border-[#FFC516] rounded-xl flex items-center justify-center text-[#FFC516] hover:bg-white/10 transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
              </div>
              <span className="text-[10px] text-[#FFC516] text-center font-medium">Undangan</span>
            </div>
        ...
        <div className="bg-white rounded-2xl mx-4 -mt-16 p-5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] relative z-10">
          <div className="grid grid-cols-4 gap-y-6 gap-x-2">
            {[
              { image: "/mart.png", label: "Gerai Mart", route: "/coming-soon?feature=Gerai Mart" },
