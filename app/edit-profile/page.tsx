...
export default function EditProfile() {
  ...
  const capturePhoto = () => {
    if (videoRef.current) {
      ...
      if (activeCamera === "selfie") setSelfieImg(imageUrl); else setKtpImg(imageUrl);
      stopCamera();
    }
  };
